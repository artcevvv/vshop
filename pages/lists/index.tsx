...
export default function FamilyCreation() {
  ...
  if (lists) {
    return (
      <div className='flex gap-[30px] max-w-[1420px] md:overflow-x-scroll flex-col w-full md:flex-row' style={{scrollbarWidth: "none"}}>
        {lists?.map((plist) => (
      ...
      <DrawerTrigger asChild >
        <Button onClick={() => setIsOpen(true)} className="h-full md:w-[500px] self-center border-solid border-[#DADADA] border-[1px] rounded-[64px] bg-transparent flex justify-center items-center w-[100%] py-48 hover:bg-transparent hover:shadow-lg">
